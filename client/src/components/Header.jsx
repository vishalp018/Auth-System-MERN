...
const Header = () => {
  return (
    ...
    <img src={assets.header_img} alt="" className='w-36 h-36 rounded-full mb-6' />
      ...
      <p className='mb-8 max-w-mb'>Let's start with a quick product tour</p>
      <button className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-100 transition-all' >Get Started</button>
      <button className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-100 transition-all' >Login</button> 
    </div>
  )
}
